...
// Accept pending film (Admin only)
Route::middleware(['auth:sanctum', RoleMiddleware::class . ':admin'])
    ->post('/films/{film}/accepted', [FilmController::class, 'accepted']);



// Festival routes (Admin + Festival Organizer)
Route::middleware(['auth:sanctum', RoleMiddleware::class . ':admin,festival organizer'])
    ->prefix('festivals')
    ->group(function () {
...
Route::middleware(['auth:sanctum', RoleMiddleware::class . ':admin'])->group(function () {
    Route::post('/subscriptions', [SubscriptionController::class, 'store']);   // create
    Route::put('/subscriptions/{id}', [SubscriptionController::class, 'update']);  // update
    Route::delete('/subscriptions/{id}', [SubscriptionController::class, 'destroy']); // delete
    Route::get('/subscriptions/user/{userId}', [SubscriptionController::class, 'getUserSubscriptions']);
    Route::get('/subscriptions/plan/{planId}', [SubscriptionController::class, 'getPlanSubscriptions']);
    Route::get('/subscriptions/active', [SubscriptionController::class, 'getActiveSubscriptions']);
});
...
Route::middleware(['auth:sanctum', RoleMiddleware::class . ':admin'])->group(function () {
    Route::post('/plans', [PlanController::class, 'store']);    // create
    Route::put('/plans/{id}', [PlanController::class, 'update']); // update
    Route::delete('/plans/{id}', [PlanController::class, 'destroy']); // delete
    Route::get('/plans/active', [PlanController::class, 'getActivePlans']);
});
